      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center md:items-end gap-4">
          <div className="flex gap-3">
            <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-lime-300/40 via-emerald-300/30 to-cyan-300/40" />
            <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-cyan-300/40 via-sky-300/30 to-indigo-400/40" />
            <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-amber-300/40 via-rose-300/30 to-violet-400/40 hidden sm:block" />
          </div>
          <a
            href="/galerie"
